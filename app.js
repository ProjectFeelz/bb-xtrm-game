    ...
    try {
        ...
        if (data && data.success) {
            ...
            if (p.tiktok_username) {
                ...
                socialsHtml += `<a href="https://tiktok.com/@${tiktok}" target="_blank" class="public-social-link tiktok">🎵 TikTok</a>`;
            }
            if (p.youtube_url) {
                socialsHtml += `<a href="${p.youtube_url}" target="_blank" class="public-social-link youtube">▶️ YouTube</a>`;
            }
            if (p.instagram_username) {
                const insta = p.instagram_username.replace('@', '');
                socialsHtml += `<a href="https://instagram.com/${insta}" target="_blank" class="public-social-link instagram">📷 Instagram</a>`;
            }
